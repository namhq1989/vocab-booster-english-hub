...
func (c *exerciseServiceClient) CountUserReadyToReviewExercises(ctx context.Context, in *CountUserReadyToReviewExercisesRequest, opts ...grpc.CallOption) (*CountUserReadyToReviewExercisesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExerciseService_CountUserReadyToReviewExercises_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *exerciseServiceClient) GetUserReadyToReviewExercises(ctx context.Context, in *GetUserReadyToReviewExercisesRequest, opts ...grpc.CallOption) (*GetUserReadyToReviewExercisesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExerciseService_GetUserReadyToReviewExercises_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
